...
;*                                                                   *
;*   Quicksilver overlay manager code                                *
;*                                                                   *
;*********************************************************************
...
; publics used by QuickSilver for parsing
EXTRN   pnoff:WORD
EXTRN   pnseg:WORD
...
; set the QuickSilver values that point to tokens to interpret
    push    ds
    mov ax,DGROUP
    mov ds,ax               ; ds -> default data segment of application
    mov ax,cs:jump_offset   ; get the called address offset
    add ax,6                ; bump past retf following far call instruction
    mov pnoff,ax            ; save offset of pointer in QuickSilver variable
    mov ax,cs:jump_segment
    mov pnseg,ax            ; save segment of pointer in QuickSilver variable
    pop ds
